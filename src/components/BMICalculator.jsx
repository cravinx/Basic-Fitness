...
const BMICalculator = () => {
    ...
    const calculateBMI = (e) => {
        ...
        if (!height || !weight || !gender){
            toast.error("Please input a valid weight, height and gender");
            return;
        }
        ...
        if (bmiValue < 18.5) {
            toast.warning(
                "You are underweight. Comsider seeking advice from a healthcare provider"
            );
            ...
            toast.error(
                "You are in the obese range. It is recommended to seek advice from a health specialist as soon as possible.."
            )
        }
    }
